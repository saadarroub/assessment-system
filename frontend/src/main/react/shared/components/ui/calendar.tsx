  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        // das td-Cell Styling bleibt gleich, nur Range-Hintergrund kommt aus range_* unten
        day: cn(
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        // Focus-Ring („blaue Ecke“) -> GOLD statt ring-ring/border-ring
