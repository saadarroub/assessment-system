...
/**
 * DTO für POST-Requests (Company erstellen)
 * Frontend kann nur diese Felder senden - keine ID, keine Timestamps
 */
public class CreateCompanyDTO {
    ...
    // Adress-Felder (optional beim Erstellen)
